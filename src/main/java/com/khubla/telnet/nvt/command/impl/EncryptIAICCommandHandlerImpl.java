   ...
   public void process(NVT nvt, int cmd) throws IOException {
      switch (cmd) {
         ...
         case IAC_COMMAND_WILL:
             ...
             */
            nvt.getNvtStream().writeBytes(IAC_IAC, IAC_COMMAND_SB, IAC_CODE_ENCRYPT, REQUEST_START, IAC_IAC, IAC_COMMAND_SE);
            nvt.getNvtStream().writeBytes(IAC_IAC, IAC_COMMAND_SB, IAC_CODE_ENCRYPT, SUPPORT, DES_CFB64, IAC_IAC, IAC_COMMAND_SE);
            break;
