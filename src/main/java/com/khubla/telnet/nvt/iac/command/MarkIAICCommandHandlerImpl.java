...
public class MarkIAICCommandHandlerImpl implements IACCommandHandler {
   /**
    * logger
    */
   static final Logger logger = LoggerFactory.getLogger(MarkIAICCommandHandlerImpl.class);
